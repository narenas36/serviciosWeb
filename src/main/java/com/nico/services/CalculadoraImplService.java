 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://services.nico.com/", wsdlLocation = "http://localhost:1550/ws/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://services.nico.com/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1550/ws/Calculadora?wsdl");
     ...
     * 
     * @return
     *     returns CalculadoraImpl
     */
    @WebEndpoint(name = "CalculadoraImplPort")
    public CalculadoraImpl getCalculadoraImplPort() {
        return super.getPort(new QName("http://services.nico.com/", "CalculadoraImplPort"), CalculadoraImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculadoraImplPort")
    public CalculadoraImpl getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.nico.com/", "CalculadoraImplPort"), CalculadoraImpl.class, features);
    }
